'''
Script for downloading selected 410 high quality textured meshes across 225 categories.
This code is from: https://github.com/daveredrum/Text2Tex/blob/main/scripts/download_objaverse_subset.py
'''
import os
import sys
import objaverse
...
if __name__ == "__main__":
    ...
    for key, value in tqdm(objects.items()):
        ...
        cmd = [
            ...
            "--background", "--factory-startup", "--python", "./blender_process_glb.py", "--",
            str(value),
            DATA_DIR
        ]
