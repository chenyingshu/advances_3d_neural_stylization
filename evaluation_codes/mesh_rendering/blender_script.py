...
Blender script to render images of 3D mesh models.
This script is adapted from: https://github.com/Roblox/FlashTex/blob/main/tools/blender_script.py
'''
...
HDRI_PATH = "./lights/studio_small_03_4k.hdr"
...
def _set_camera_rotate_above(i: int, scale: float = 1.5) -> bpy.types.Object:
    """Debugging function to set the camera on the 6 faces of a cube.
    ...
    """
    if i == 0:
        x, y, z = scale, 0, scale/3
    elif i == 1:
        x, y, z = -scale, 0, scale/3
    elif i == 2:
        x, y, z = 0, scale, scale/3
    elif i == 3:
        x, y, z = 0, -scale, scale/3
    elif i == 4:
        x, y, z = 0, 0, scale
...
def render_object(
    ...
    for i in range(num_renders):
        ...
        # )
        # uniformly sample views
        camera = _set_camera_rotate_above(i % 6, scale = 5)
        ...
        # the setting of FlashTex to render an object with different materials
        # idx = 1
        # for i_r in range(2):
        #     for i_m in range(2):
        #         swap_material(0, idx)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1024,
        help="Resolution of the rendering (for both width and height).",
    )
