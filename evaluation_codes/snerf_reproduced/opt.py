...
Adapted from Plenoxels by Alex Yu
https://github.com/Kai-46/ARF-svox2/tree/master/opt
'''
...
group.add_argument("--init_ckpt", type=str, default="", help="initial checkpoint to load")
...
if args.init_ckpt is not None:
    grid = svox2.SparseGrid.load(args.init_ckpt, device=device)
    # grid = svox2.SparseGrid.load(args.init_ckpt, device=device, reset_basis_dim=1)
else:
